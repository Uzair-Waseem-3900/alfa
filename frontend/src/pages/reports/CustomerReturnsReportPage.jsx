...
import { Undo2, Printer, SlidersHorizontal, X } from 'lucide-react';
...
const columns = [
    ...
    {
        key: 'total_return_cogs',
        label: 'Return COGS (PKR)',
        render: (value) => {
            const num = typeof value === 'string' ? parseFloat(value) : value;
            return isNaN(num) ? '0.00' : num.toFixed(2);
        },
...
const CustomerReturnsReportPage = () => {
    const { user } = useAuth();
    ...
    } = usePaginatedList(reportsApi.customerReturns.get, {});
        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                    ...
                    <h1 className="text-3xl font-bold text-neutral-900">Customer Returns Report</h1>
                </div>
                <p className="text-neutral-500 mt-1">Accepted returns from customers for a selected date or date range</p>
            </div>
...
export default CustomerReturnsReportPage;
