...
import { Wallet, Printer, SlidersHorizontal, X } from 'lucide-react';
...
const CashCollectedReportPage = () => {
    ...
    } = usePaginatedList(reportsApi.cashCollected.get, {});
    ...
    const handlePrint = async () => {
        setPrinting(true);
        try {
            await printReport('/reports/cash-collected/print/', filters);
        } catch (err) {
        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                    ...
                    <h1 className="text-3xl font-bold text-neutral-900">Cash Collected Report</h1>
                </div>
