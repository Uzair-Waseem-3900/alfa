...
# "Indexed search always"). The other columns cash_flow's breakdown selectors
# search (customer name/code, supplier name/code, lost-inventory reference)
# already have trigram indexes from billing 0005 / purchases 0011.
_TRIGRAM_TARGETS = [
    ("cash_flow_expense", "name"),
    ("cash_flow_expense", "description"),
]
