...
const ExpensesReportPage = () => {
    ...
    } = usePaginatedList(reportsApi.expenses.get, {});
    ...
    const handlePrint = async () => {
        setPrinting(true);
        try {
            await printReport('/reports/expenses/print/', filters);
        } catch (err) {
        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                    ...
                    <h1 className="text-3xl font-bold text-neutral-900">Expenses Report</h1>
                </div>
                <p className="text-neutral-500 mt-1">Total expenses and their value for a selected date or date range</p>
            </div>
                    ...
                    {stats && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Card className="p-4">
                                ...
                                <p className="text-2xl font-bold text-neutral-900">{stats.total_expenses}</p>
                            </Card>
                            <Card className="p-4">
                                <p className="text-sm text-neutral-500">Total Expenses (PKR)</p>
                                <p className="text-2xl font-bold text-error-600">
                                    {Number(stats.total_expenses_cash || 0).toFixed(2)}
                                </p>
                            </Card>
                        </div>
                    )}
